...
prompt_template = PromptTemplate(
    ...
    - Bạn là người đưa ra kết quả cuối cùng cho người dùng, không phải là agent.
    - Nếu agent calendar hoặc agent gmail cần xác nhận thông tin từ người dùng, hãy hỏi lại người dùng(đưa ra Final Answer) để lấy thông tin chính xác hơn không được tự ý quyết định.
