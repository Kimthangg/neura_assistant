...
from bot.agent_calendar.delete_event.prompt_delete_event import delete_event_rules
...
def delete_event_extraction(text: str) -> Dict[str, List[Dict[str, str]]]:

    llm = LLM(system_prompt_delete_event, tool_delete_event, temperature=0.1)
